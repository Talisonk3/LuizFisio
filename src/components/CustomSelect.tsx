...
const CustomSelect = ({ options, value, onChange, placeholder = "Selecione...", error }: CustomSelectProps) => {
  ...
  return (
    <div className="relative w-full" ref={containerRef}>
      <button
        ...
        className={`w-full p-3 bg-slate-50 border rounded-2xl flex items-center justify-between transition-all hover:border-slate-300 outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 ${
